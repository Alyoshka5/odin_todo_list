...
const todoDom = (() => {
    ...
    function displayTodo(todo) {
        ...
        let formatedDueDate = todo.dueDate ?  '⏳ ' + (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(todo.dueDate), `dd/MM/yyyy p`) : '';
        todosDiv.innerHTML += `
